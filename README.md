...
# Model
The input, which is a word and a pattern are used as data to filter out words from the initial list of all possible guesses, and then the next best guess is derived from the sorted list of Shannon Entropies of all the words in the filtered list. 
